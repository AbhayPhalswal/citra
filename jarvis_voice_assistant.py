...
from citra_protocols import PROTOCOL_REGISTRY, SemanticRouter
...
# The protocol handlers speak through the same TTS as everything else.
citra_protocols.set_speaker(speak_async)
